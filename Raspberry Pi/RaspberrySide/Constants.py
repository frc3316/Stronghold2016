...
# Color Filter:
LOWER_COLOR_BOUND = np.array([85, 220, 230]) # Lower bond
...
# Bounding rectangle
MIN_BOUND_RECT_AREA = 200 # The minimum area of a contour to be considered as a possible object (U). the area is calculated using
# cv2.contourArea
...
# cv2.contourArea
MAX_HIGHT_WIDTH_RATIO = 1 # The maximum ratio of height/width of the bounding rectangle of a contour to be considered as a potential contour.
MIN_HIGHT_WIDTH_RATIO = 0.5 # The maximum ratio of height/width of the bounding rectangle of a contour to be considered as a potential contour.
