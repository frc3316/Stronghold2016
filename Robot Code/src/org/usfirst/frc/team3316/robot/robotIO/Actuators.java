...
public class Actuators
{
	...
	// Chassis
	public DBugSpeedController chassisLeft1, chassisLeft2, chassisRight1,
			chassisRight2;
	public SpeedController chassisLeft1SC, chassisLeft2SC, chassisRight1SC,
			chassisRight2SC;

	public DoubleSolenoid chassisLongPistons, chassisShortPistonsLeft,
			chassisShortPistonsRight;
	...
	public DBugSpeedController climbingMotor1, climbingMotor2, climbingMotor3,
			climbingMotor4;
	public SpeedController climbingMotorSC1, climbingMotorSC2, climbingMotorSC3,
			climbingMotorSC4;
	...
	public Actuators()
	{
		...
		if (config.robotA)
		{
			...
			climbingMotorSC1 = new VictorSP(
					(int) Robot.config.get("CLIMBING_MOTOR_1"));
			climbingMotorSC2 = new VictorSP(
					(int) Robot.config.get("CLIMBING_MOTOR_2"));
			climbingMotorSC3 = new VictorSP(
					(int) Robot.config.get("CLIMBING_MOTOR_3"));
			climbingMotorSC4 = new VictorSP(
					(int) Robot.config.get("CLIMBING_MOTOR_4"));
		...
		else
		{
			...
			// meantime but we're ignoring it.
			chassisLeft1SC = new Talon(
					(int) Robot.config.get("CHASSIS_MOTOR_LEFT_1"));
			chassisLeft2SC = new Talon(
					(int) Robot.config.get("CHASSIS_MOTOR_LEFT_2"));
			chassisRight1SC = new Talon(
					(int) Robot.config.get("CHASSIS_MOTOR_RIGHT_1"));
			chassisRight2SC = new Talon(
					(int) Robot.config.get("CHASSIS_MOTOR_RIGHT_2"));

			intakeSC = new Talon((int) Robot.config.get("INTAKE_MOTOR"));

			transportSC = new CANTalon(
					(int) Robot.config.get("TRANSPORT_MOTOR"));
			...
			climbingMotorSC1 = new CANTalon(
					(int) Robot.config.get("CLIMBING_MOTOR_1"));
			climbingMotorSC2 = new CANTalon(
					(int) Robot.config.get("CLIMBING_MOTOR_2"));
			climbingMotorSC3 = new CANTalon(
					(int) Robot.config.get("CLIMBING_MOTOR_3"));
			climbingMotorSC4 = new CANTalon(
					(int) Robot.config.get("CLIMBING_MOTOR_4"));
		...
		chassisLongPistons = new DoubleSolenoid(
		...
		intakeMotor = new DBugSpeedController(intakeSC,
		 ...
		 * Turret
		 */
		turretMotor = new DBugSpeedController(turretSC,
		 ...
		 * Hood
		 */
		hoodMotor = new DBugSpeedController(hoodSC,
				(boolean) Robot.config.get("HOOD_MOTOR_REVERSE"),
		...
		climbingSolenoid = new DoubleSolenoid(
				(int) Robot.config.get("CLIMBING_SOLENOID_MODULE"),
