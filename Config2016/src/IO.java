	...
	public static void initIO()
	{
		try
		{
			 ...
			 */
			{
				 ...
				 */
				{
					putPWMB("CHASSIS_MOTOR_RIGHT_1", 0);
					putPWMB("CHASSIS_MOTOR_RIGHT_2", 1);
					putPWMB("CHASSIS_MOTOR_LEFT_1", 2);
					putPWMB("CHASSIS_MOTOR_LEFT_2", 3);

					putPWMB("INTAKE_MOTOR", 11);

					putCANB("TRANSPORT_MOTOR", 7);

					putCANB("FLYWHEEL_MOTOR", 6);

					putCANB("TURRET_MOTOR", 4);

					putCANB("HOOD_MOTOR", 5);

					putCANB("CLIMBING_MOTOR_1", 12);
					putCANB("CLIMBING_MOTOR_2", 13);
					putCANB("CLIMBING_MOTOR_3", 14);
					putCANB("CLIMBING_MOTOR_4", 15);
					
					putCANB("SPARE_MOTOR", 10); // Check this with electronics
				}
			}
			 ...
			 */
			{
				...
				putDIO("CHASSIS_RIGHT_ENCODER_CHANNEL_B", 1);
				
				putDIO("CHASSIS_LEFT_ENCODER_CHANNEL_A", 2);
				putDIO("CHASSIS_LEFT_ENCODER_CHANNEL_B", 3);

				putDIO("CHASSIS_HALL_EFFECT_LEFT_FRONT", 4);
				putDIO("CHASSIS_HALL_EFFECT_LEFT_BACK", 5);
				putDIO("CHASSIS_HALL_EFFECT_RIGHT_FRONT", 6);
			 ...
			 */
			{
				putPDP("CHASSIS_MOTOR_RIGHT_1_PDP_CHANNEL", 0);
				putPDP("CHASSIS_MOTOR_RIGHT_2_PDP_CHANNEL", 1);
				
				putPDP("CHASSIS_MOTOR_LEFT_1_PDP_CHANNEL", 2);
				putPDP("CHASSIS_MOTOR_LEFT_2_PDP_CHANNEL", 3);

				putPDP("INTAKE_MOTOR_PDP_CHANNEL", 11);

				putPDP("TRANSPORT_MOTOR_PDP_CHANNEL", 7);

				putPDP("FLYWHEEL_MOTOR_PDP_CHANNEL", 6);

				putPDP("TURRET_MOTOR_PDP_CHANNEL", 4);

				putPDP("HOOD_MOTOR_PDP_CHANNEL", 5);

				putPDP("CLIMBING_MOTOR_1_PDP_CHANNEL", 12);
				putPDP("CLIMBING_MOTOR_2_PDP_CHANNEL", 13);
				putPDP("CLIMBING_MOTOR_3_PDP_CHANNEL", 14);
				putPDP("CLIMBING_MOTOR_4_PDP_CHANNEL", 15);
				
				putPDP("SPARE_MOTOR_PDP_CHANNEL", 10);
			}
