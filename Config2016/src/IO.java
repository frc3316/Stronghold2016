	...
	public static void initIO()
	{
		try
		{
			 ...
			 */
			{
				...
				putDIO("INTAKE_LEFT_SWITCH", 11);
				putDIO("INTAKE_RIGHT_SWITCH", 10);
			 ...
			 */
			{
				...
				Config.addToConstants("CLIMBING_SOLENOID_FORWARD", 0);
				Config.addToConstants("CLIMBING_SOLENOID_REVERSE", 1);
			}
		}
		catch (Exception e)
		{
